...
- pin_list:
  ...
  - {pin_num: '33', peripheral: SIUL2, signal: 'gpio, 30', pin_signal: PTA30, identifier: LED2_GREEN, direction: OUTPUT, InitValue: state_1}
  - {pin_num: '39', peripheral: SIUL2, signal: 'gpio, 31', pin_signal: PTA31, direction: OUTPUT, InitValue: state_1}
  - {pin_num: '42', peripheral: SIUL2, signal: 'gpio, 50', pin_signal: PTB18, identifier: LED4_YELLOW, direction: OUTPUT, InitValue: state_1}
