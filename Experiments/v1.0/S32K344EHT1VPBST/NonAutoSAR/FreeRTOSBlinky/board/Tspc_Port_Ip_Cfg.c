...
- pin_list:
  - {pin_num: '32', peripheral: SIUL2, signal: 'gpio, 29', pin_signal: PTA29, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: '33', peripheral: SIUL2, signal: 'gpio, 30', pin_signal: PTA30, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: '39', peripheral: SIUL2, signal: 'gpio, 31', pin_signal: PTA31, identifier: LED3_RED, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
