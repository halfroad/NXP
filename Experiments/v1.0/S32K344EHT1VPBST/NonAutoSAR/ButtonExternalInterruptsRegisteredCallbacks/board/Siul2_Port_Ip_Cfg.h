...
#define LED1_BLUE_PIN           13u
#define LED1_BLUE_PORT          PTA_H_HALF
#define LED2_GREEN_PIN          14u
#define LED2_GREEN_PORT         PTA_H_HALF
#define LED3_RED_PIN            15u
#define LED3_RED_PORT           PTA_H_HALF
#define LED4_YELLOW_PIN         2u
#define LED4_YELLOW_PORT        PTB_H_HALF
#define KEY1_PTB19_PIN          3u
#define KEY1_PTB19_PORT         PTB_H_HALF
#define KEY2_PTB20_PIN          4u
#define KEY2_PTB20_PORT         PTB_H_HALF
#define KEY3_PTB26_EXIT_13_PIN  10u
#define KEY3_PTB26_EXIT_13_PORT PTB_H_HALF
