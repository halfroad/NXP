...
- pin_list:
  - {pin_num: R9, peripheral: SIUL2, signal: 'gpio, 58', pin_signal: PTB26, direction: INPUT, InitValue: state_0}
  - {pin_num: R2, peripheral: SIUL2, signal: 'gpio, 51', pin_signal: PTB19, direction: INPUT, InitValue: state_0}
  - {pin_num: T1, peripheral: SIUL2, signal: 'gpio, 52', pin_signal: PTB20, direction: INPUT, InitValue: state_0}
  - {pin_num: M3, peripheral: SIUL2, signal: 'gpio, 29', pin_signal: PTA29, identifier: LED1_BLUE, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: P3, peripheral: SIUL2, signal: 'gpio, 30', pin_signal: PTA30, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: P1, peripheral: SIUL2, signal: 'gpio, 31', pin_signal: PTA31, identifier: LED3_RED, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: R1, peripheral: SIUL2, signal: 'gpio, 50', pin_signal: PTB18, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
