...
#if ((defined(MCU_DISABLE_DEM_REPORT_ERROR_STATUS) && (MCU_DISABLE_DEM_REPORT_ERROR_STATUS == STD_OFF)) || (defined(MCU_ERROR_ISR_NOTIFICATION)) || (defined(MCU_PMC_NOTIFICATION)))
