...
- pin_list:
  ...
  - {pin_num: R2, peripheral: SIUL2, signal: 'gpio, 51', pin_signal: PTB19, direction: OUTPUT}
  - {pin_num: T1, peripheral: SIUL2, signal: 'gpio, 52', pin_signal: PTB20, direction: OUTPUT}
