...
extern void PTB19_EIRQ_CALLBACK(void);
extern void PTB20_EIRQ_CALLBACK(void);
extern void PTB26_EIRQ_CALLBACK(void);
...
*/
const Siul2_Icu_Ip_ChannelConfigType Siul2_Icu_Ip_0_ChannelConfig_PB[3U] =
{
