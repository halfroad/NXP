...
- pin_list:
  ...
  - {pin_num: '32', peripheral: SIUL2, signal: 'gpio, 29', pin_signal: PTA29, identifier: LED1_RED, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: '33', peripheral: SIUL2, signal: 'gpio, 30', pin_signal: PTA30, identifier: LED2_GREEN, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: '39', peripheral: SIUL2, signal: 'gpio, 31', pin_signal: PTA31, identifier: LED3_BLUE, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: '42', peripheral: SIUL2, signal: 'gpio, 50', pin_signal: PTB18, identifier: LED4_YELLOW, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  ...
  - {pin_num: '94', peripheral: LPI2C0, signal: lpi2c0_scls, pin_signal: PTB1, direction: INPUT/OUTPUT}
  - {pin_num: '95', peripheral: LPI2C0, signal: lpi2c0_sdas, pin_signal: PTB0, direction: INPUT/OUTPUT}
  - {pin_num: '141', peripheral: LPI2C1, signal: lpi2c1_sda, pin_signal: PTC6, direction: INPUT/OUTPUT}
  - {pin_num: '140', peripheral: LPI2C1, signal: lpi2c1_scl, pin_signal: PTC7, direction: INPUT/OUTPUT}
